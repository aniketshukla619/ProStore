            ...
            protected void populateViewHolder(final MenuViewHolder viewHolder, Dummy model, int position) {
                ...
                viewHolder.setItemClickListener(new ItemClickListener() {
                    ...
                    public void onClick(View view, int position, boolean isLongClick) {
                        Intent intent=new Intent(Fashion.this,ItemList.class);
                        intent.putExtra("select", adapter.getRef(position).getKey());
                        intent.putExtra("item","List of Items");
                        intent.putExtra("category",viewHolder.textMenuName.getText().toString());
